...
\begin{parts}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
\part[$2$] \color{red}If you want to put two or more figures side by side then you can use the latex minipage environment.\color{black} What is super Node? What is the difference between Super Mesh \& Mesh?\droppoints

\begin{solution}

\end{solution}	
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%	
\part[$4$]Using nodal analysis, determine the potential across the $4~\unit{\Omega}$ resistor in Fig.~\ref{fig:ckt-nodal-analysis} \droppoints
...
\end{solution}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%	
\part[$4$]Use mess analysis to find currents and voltage $v_o$ in the circuit of Fig.~\ref{fig:ckt-mesh-analysis} \droppoints
