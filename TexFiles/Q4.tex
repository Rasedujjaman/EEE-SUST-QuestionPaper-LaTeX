...
\begin{parts} 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%	
\part[$4$]Determine $I_{BQ}$, $I_{CQ}$, $V_{CEQ}$, $V_B$, $V_C$ and $V_{BC}$ for the fixed-bias configuration shown in Fig.~\ref{fig:ckt-bjt-fixed-bias}. \droppoints
...
\end{solution}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%		
\part[$2$]Determine the saturation level for the network of Fig.~\ref{fig:ckt-bjt-fixed-bias}.\droppoints
...
\end{solution}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\part[$4$]For the emitter bias network of Fig.~\ref{fig:ckt-bjt-emitter-bias} determine   $I_{B}$, $I_{C}$, $V_{CE}$, $V_C$, $V_E$ and $V_B$ for the fixed-bias configuration shown in  \droppoints
