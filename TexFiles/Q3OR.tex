...
\begin{parts}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%	
\part [$4$]Find the Thevenin's equivalent circuit of Fig.~\ref{fig:ckt-thevenin-equivalent} to the left of the terminal. \droppoints
...
\end{solution}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\part [$4$]Find the magnitude $R_L$ for the maximum power transfer in the circuit shown in Fig.~\ref{fig:ckt-max-power}. Also find out the maximum power. \droppoints
...
\end{solution}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\part[$2$] Write short notes on Real power and Reactive power. \droppoints
