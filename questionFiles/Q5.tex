...
\begin{parts} 	
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%		
\part[4]\color{red} If you want the subparts of the question to be appeared inline the use the command \verb|\begin{inlinesubparts} \item, \item, etc.---\end{inlinesubparts}|. \color{black} As for example: For the circuit in Fig.~\ref{fig:ckt-inductor-acanalysis}, 
	 $i(t) = 4(2-e^{-10t})~\si{\milli\ampere}$. If $i_2(t) = \SI{-1}{\milli\ampere}$, Find:
...
\end{solution}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%	
\bdpart[1+1+1]  \color{red} If you want the marks to be displayed as \(1+1+1\), use the command \verb|\bdpart[1+1+1]| instead of the regular \verb|\part[]| command. \color{black} As for example: Determine the currents $I_1$, $I_2$ and $I_{D2}$ for the network of Fig.~\ref{fig:ckt-diode-dcanalysis}.
