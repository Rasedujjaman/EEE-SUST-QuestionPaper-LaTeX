...
\begin{parts}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%		
\part[4]\color{red} If you want to place two figures side by side then use minipage environment. As for example: \color{black}For the circuit shown in Fig.~\ref{fig:ckt-thevenin-dc}, calculate the current in the \SI{10}{\ohm} resistance. Use Thevenin's theorem only.
